...
const PreviewModal = ({ data, onConfirm, onCancel }) => {
  ...
  const renderJewelryDetails = () => {
    ...
    switch (data.jewelryType) {
      case "Ring":
        typeSpecificDetails.push({
          label: "Ring Size",
          value: `${details.ringSize} (${details.sizeUnit})`,
        });
        break;
      case "EarRing":
        typeSpecificDetails.push({
          label: "Fitting Type",
          value: details.fittingType,
        });
        break;
      case "Bracletes":
        typeSpecificDetails.push({
          label: "Bracelet Size",
          value: `${details.braceletSize} inches`,
        });
        break;
      case "Necklace":
        typeSpecificDetails.push({
          label: "Necklace Size",
          value: `${details.necklaceSize} inches`,
        });
        break;
      case "Pendant":
    ...
    return [...commonDetails, ...typeSpecificDetails].map(
      (item, index) =>
        item.value && (
